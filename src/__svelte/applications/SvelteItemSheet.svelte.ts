...
class SvelteItemSheet<
  ...
  Configuration extends SvelteItemSheet.Configuration<
    D
  > = SvelteItemSheet.Configuration<D>,
  RenderOptions extends SvelteItemSheet.RenderOptions =
    SvelteItemSheet.RenderOptions,
